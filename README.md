...
- Note that there is no zero in Roman numerals (the Romans had no need for it, apparently). I've therefore just incuded 'N' (= <em>nihil</em> = 'nothing') when the hour, minute, or second = zero in the 24-hour clock.
